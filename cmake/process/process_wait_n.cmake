  ...
  ## 
  ##
  ## callbacks have access to the following scope variables
  ...
  function(process_wait_n n)
    arguments_extract_typed_values(0 ${ARGC}
      ...
      [--timeout:<int>?]
      [--process-terminated-callback:<callable>]
    )
    ans(process_handles)
    ...
    while(true)
      ...
      while(queue)
        ...
        if(NOT is_running)
          ...
          if(process_terminated_callback)
            call2("${process_terminated_callback}")
          endif()
        endif()
