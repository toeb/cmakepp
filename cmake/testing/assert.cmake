...
function(assert)
	...
	set(oneValueArgs EXISTS EXCEPTION COUNT MESSAGE RESULT MESSAGE_TYPE CONTAINS MISSING MATCH MAP_MATCHES FILE_CONTAINS)
	...
	#	message("predicate '${_PREDICATE}'")
		...
		ans(result)
	elseif(_EXCEPTION)
		is_exception("${_UNPARSED_ARGUMENTS}")
		ans(is_exception)
		set(result false)

		if(is_exception)

			map_tryget("${_UNPARSED_ARGUMENTS}" code)
			ans(exception_type)
			if("${_EXCEPTION}_" STREQUAL "${exception_type}_")
				set(result true)
			else()
				set(_MESSAGE "invalid exception: expected exception code to be '${_EXCEPTION}', got '${exception_type}'")
			endif()
		endif()
