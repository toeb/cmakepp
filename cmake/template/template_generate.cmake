...
function(template_generate content)
  ...
  foreach(fragment ${fragments})
    ...
    if("${fragment}" MATCHES "${code_fragment_regex}")
      ...
      if(do_output)
        set(result "${result}\nref_append_string(\${__template_output_ref} \"\${__ans}\")")
      endif()
    else()
      cmake_string_escape("${fragment}")
      ans(fragment)
      set(result "${result}\nref_append_string(\${__template_output_ref} \"${fragment}\")")
    endif()

  endforeach()
  set(result "ref_new()
    ans(__template_output_ref)${result}
    ref_get(\${__template_output_ref})")
