  ...
  function(cmake_ast_parse code)
    ...
    cmake_parse_string("${code}" --extended)
    ans(tokens)
    ...
    while(true)
      token_find_next_type("${current_invocation}" command_invocation)
      ...
      cmake_function_parse("${current_nesting}" "${current_invocation}")
      cmake_variable_parse("${current_nesting}" "${current_invocation}")
