 ...
 function(ast_parse_list )#definition stream create_node
   ...
   # message("parsing list")
    ...
    map_tryget(${definition} begin begin)
    map_tryget(${definition} end end)
    map_tryget(${definition} separator separator)
...
#    message("creating node")
    ...
    map_isvalid("${begin_ast}" isnode)
    if(NOT isnode)
      set(begin_ast)
    endif()
    map_isvalid("${end_ast}" isnode)
    if(NOT isnode)
      set(end_ast)
    endif()
